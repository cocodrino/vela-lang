...
**VELA:**
From den, evri morne bifor kraud bird-en awaik-ed, smol bird wake-ed wit sun first lait. Li go-ed tu river side, stand-ed on ston, and breth-ed deep. Li tink-ed about wind, about mat-en warm wing, about moon on watre, about pain and hop tugeter. Den li sing-ed wan not. Neks morne, tu not-en. Neks week, long sonj line. Sam day voys brok-ed agen, and li krei-ed. Bot li kontinyu-ed bikos owl tok-ed, "Pasi bring-a flauor from hard erd."
...
### Tense System in Narrative
The story uses the VELA tense system consistently:

| Tense | Marker | Example | Context |
|-------|--------|---------|---------|
| Past narration | `-ed` | `liv-ed`, `flai-ed`, `tok-ed` | Most of the story |
| Present dialogue | `-a` | `no sing-a`, `start-a`, `bring-a` | Direct speech |
| Future | `-wil` | Not used in this story | — |

### Dialogue Marking
Direct speech uses `" "` quotation marks, standard in VELA orthography. The tense shifts from past narration to present dialogue — a natural register shift confirmed by grammar rules.

### New Words Used (Contextual Adaptations)

| Word | Form | Meaning | Source | Justification |
|------|------|---------|--------|---------------|
| kwaiet | quietly | English "quiet" + vowel | English | Adverb from adjective |
| krei | cry | English "cry" adapted | English | Verb, emotionally needed |
| throt | throat | English "throat" | English | Body part |
| pasi | patience | English "patience" | English | Abstract virtue |
| biliv | believe | English "believe" | English | Mental verb |
| proud | proud | English "proud" | English | Emotional state |
| teer | tear (from eye) | English "tear" | English | Physiological |
| raiz | rise | English "rise" | English | Motion verb |

**Note:** These are contextual adaptations for storytelling. Whether they become permanent lexicon entries requires committee review.

### Compound Usage
The story uses descriptive compounds where clear:
- `river side` (riverside) — transparent compound
- `sun first lait` (first sunlight) — descriptive phrase
- `dark tre` (dark tree) — adjective + noun

---

## Vocabulary Gaps Exposed

| English | VELA Used | Should be atom? | Notes |
|---------|-----------|-----------------|-------|
| quietly | kwaiet | Maybe | Common adverb |
| cry | krei | Yes | Core emotional verb |
| throat | throt | Yes | Body part |
| patience | pasi | Yes | Already in lexicon! ✅ |
| believe | biliv | Yes | Core mental verb |
| proud | proud | Maybe | Emotional state |
| tear (eye) | teer | Maybe | Physiological |
| rise (sun) | raiz | Yes | Common verb |

---

*Fase 8 — Textos y Muestras: Cuento corto COMPLETO (1/1)*
